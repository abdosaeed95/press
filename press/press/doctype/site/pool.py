...
class SitePool:
    def __init__(self):
        ...
        self.pool_size = frappe.db.get_single_value(
            "Press Settings", "standby_pool_size")
        self.queue_size = frappe.db.get_single_value(
            "Press Settings", "standby_queue_size")

    def create(self):
        pooling_enabled = frappe.db.get_single_value(
            "Press Settings", "enable_site_pooling")
