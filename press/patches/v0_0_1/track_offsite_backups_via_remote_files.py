...
def execute():
    ...
    for offsite_backup in offsite_backups:
        ...
        if offsite_job_payload:
            remote_database = offsite_job_payload.get(
                offsite_backup.get("database_file"))
            remote_public = offsite_job_payload.get(
                offsite_backup.get("public_file"))
            remote_private = offsite_job_payload.get(
                offsite_backup.get("private_file"))
            ...
            if remote_database:
                ...
                remote_file.save(ignore_permissions=True)
            ...
            offsite_backup.save(ignore_permissions=True)
